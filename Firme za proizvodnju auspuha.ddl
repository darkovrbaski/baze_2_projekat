...
ALTER TABLE je_obucen
    ADD CONSTRAINT je_obucen_mzs_fk FOREIGN KEY ( idmzs )
...
ALTER TABLE saradjuje
    ADD CONSTRAINT saradjuje_firma_fkv1 FOREIGN KEY ( idf_s )
        REFERENCES firma ( idf );
...
ALTER TABLE serviser
    ADD CONSTRAINT serviser_uredjaj_fk FOREIGN KEY ( idu )
        REFERENCES uredjaj ( idu );
...
ALTER TABLE zavarivac
    ADD CONSTRAINT zavarivac_azz_fk FOREIGN KEY ( idazz )
...
CREATE OR REPLACE TRIGGER arc_fkarc_1_serviser BEFORE
...
CREATE OR REPLACE TRIGGER arc_fkarc_1_zavarivac BEFORE
